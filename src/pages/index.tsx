  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Elevate your business efficiency with HR Management Application, the comprehensive solution to streamline your human resources processes."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Elevate your business efficiency with HR Management Application, the comprehensive solution to streamline your human resources processes.`}
            </Text>
            <Box
